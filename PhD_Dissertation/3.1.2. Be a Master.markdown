...
Die Tendenz ist heute nicht der Biennale-Markt als Speicherort und  geographischen Darstellung (wie britische Sensation) , aber die Bereiche, die das Hauptanliegen der verschiedenen Kuratoren, zum Beispiel "die Männer und Mäuse" von Maurizio Catalan letzten Berlin Biennale sind werden von den Künstlern der Herkunftsländer bearbeitet. 
