...
die Qualität darf nicht wegen der politischen Anwendung nachlassen. ??? Ich weiß nicht, was hier mit Anwendung gemeint ist ??? Der Autor als Produzent trägt die These: Künstler sind im politischen 
...
??? folgender teil ist ziemlich unklar. ich würde auch den vergleich zu biowelt rausnehmen. ???
...
Der Zustand des Künstlers heute ist dem des Autors und anderen kreativ orientierten Menschen ähnlich. In einem Gespräch mit Ivan Ivanji ??? Wer hat hier mit Ivan gesprochen und wer ist Ivan? Bräuchte ne Fussnote ??? erzählte er, 
...
??? ich würde den folgenden abschnitt rausnehmen. er ist sowieso noch unklar, so wie er da steht. und was ist WV? ???
...
Valenta; Albrecht; Patermann; Weinlich; Brown; Hannemann; ??? Hier fehlen die Erklärunge zu den einzelnen Leuten ???
