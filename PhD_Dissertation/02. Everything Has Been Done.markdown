...
(Kunstwerk Titel der Kunstgruppe Azzoro, PL 2003 ???ok so???)
...
geniale in der Übertragung (oder Übersetzung) einer Idee vom Kopf durch die Hand und von dort zum leeren Bogen? Oder wird es igrdendwann
...
mit Urheberrechten im Angesicht der Entwicklung vom *Creative Commons* und ähnlichen Organisationen in der Kunstwelt? 
...
> "I went from being an artist that makes things to being an artist that makes things happen" - Jeremy Deller (hier oder zum Fazit?!)
