...
Die Verhältnisse sind heutzutage zeigen, dass man vielfältig sein muss. Es bleibt einem nichts übrig, man muss alles können, oder anders formuliert: 
...
bezahlt man dafür. Irgendwann erkennt man, das man wie ein Dirigent, über sich, und über alle, die für Ihn produzieren.????????????????????????????? 
...
läuft die Kreativität (oder Leistung) hin, zuru Kooperationen als Berater und Denkfabrikanten ??????????????, bis zur Stellen bei Konzernen 
...
Das Internet hat die Arbeitsverhältnisse weiter geändert, jeder Mensch ist in der Lage, von Zuhause seine Geschäfte zu erledigen. Dauerstellung 
(Daueranstellung???????????????) werden auch immer geringer, und man arbeitet von begrenzter Stelle zur nächsten, oder an Kurzfristigeren Projekten. Dies 
...
etwas als Urlaub empfinden, sind sie weiter Kreative.???????????????????????????
Tageszeiten, Wochenpläne, Wochenende, Feiertage sind Strukturen, an denen sich KünstlerInnen grundsätzlich anpassen müssen. Die Kreativität kennt keine solche
Strukturen, sie braucht die Freiheit (und die 'Todeslinie' am Ende, damit überhaupt etwas festgelegt werden kann.

Die Hinnahme der Tatsache dass der Arbeitsplatz nicht mehr die Entscheidungen des Leben bedeuten bzw. bestimmen muss, das es auch durch die Globalisierung 
möglich ist, haben vorallem KünstlerThink Tank ???????????????????????
...
Es ist noch etwas früh festzustellen, wie die Wirkung auf den Werdegang der Studierenden einwirkt?????????????????. Exemplare zeigen aber, 
