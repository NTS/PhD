...
Praktische Erfahrungen in Sachen Sponsoring und Genehmigungen bei der Stadt und den Behörden konnten auch gesammelt werden. Wir machten Kunst im öffentlichen Raum. 
Für jede Ausstellung wurde eine Pressemitteilung von einem Student verfasst. Wir sind ins System reingeschlüpft. 
...
Manche haben sich an der Liste bedient, aber manche sind selber mit Vorschläge zu uns gekommen. In der vierten Ausstellung mit der Künstlerin Anna Gierster, kam es zu einigen 
Missverständnissen, die schlussendlich in einer offiziellen Pressekonferenz enden musste: Gierster hatte den Kiosk zu einer Außenstelle bzw. Filiale der Weimar 
Stadtwerke (Energieversorgung) umfunktioniert. Eine Woche später kam ein Anruf, wir sollen es abbauen, den es würden sich Kunden melden und bemängeln, dass es keine Öffnungszeiten gibt 
