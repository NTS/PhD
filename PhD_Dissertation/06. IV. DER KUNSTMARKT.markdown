...
Was für einen Einfluss hat dies auf Parameter der Kritik? Was ist, wenn Kunst im Netz selbstständig gestellt wird und dafür 'likes' auf Blogs und Facebook bekommt, ist es gleichwertig 
...
Als Künstler habe ich sehr viele Erfahrungen und Kenntnisse sowie Know-how überwiegend selbstständig gesammelt, und dies versuche ich an den Studierenden weiterzugeben.
Noch ist es etwas früh um festzustellen, wie die Wirkung auf den Werdegang der Studierenden sein wird. Die erste "Resultate", heißt, die erste Spuren von neue Künstlerische 
Strategien, getragen von Studenten und Absolventen der Bauhaus Universität, fangen sichtbar zu werden. 
...
und diese leiten oder selbst dort ausstellten. 
...
- Benedikt Braun
    ...
    - Zu seinem Diplom hat er ein für den Kunstmarkt umfangreiche Ausbreitung vorbereitet, mit Retrospektive, wenn auch als fiktive Ausstellung in eine fiktive Galerie mit (einem echtem) Katalog in dem schreiben fiktive Kunsthistoriker, Kuratoren und andere Kunstkenner über ihm und seiner Arbeit. 
    - Direkt nach seinem Diplom, ist er strategisch ein "Hartz-4-Empfänger" geworden, und hatte zum Thema ein neues Arbeitszykus begonnen. 

- Cosima Göpfert -- eröffnete ihre Atelier als Laden im Stadtmitte und treibt das Kunstkartell zur Vermittlung und Verkauf von Kunst.
...
- Christoph Kraus hatte den *Kunstraum Kraus* in der Marienstr. eröffnet, Der Anfang war gut aber es fehlte die Möglichkeit während des Studiums den Ort ernsthaft zu betreiben. 
  - Zusammen mit Fabian Fontain und Marc Aaron Faesser, haben sie es geschafft bei der kulturfonds Geld zu aqkuirieren, um während der Documenta 13 an eine rennomierte Stelle ein [gemeinsames Kunstobjekt](http://www.tlz.de/web/zgt/kultur/detail/-/specific/Bauhaus-Studenten-zeigten-Installation-zur-Documenta-1144759424) zu installieren.

- Lucian Patermann 
    - Initiative Marke.6, mehrere Preise und in alle Bauhaus Essentials (1-3) von der Jury in den ersten 20 Plätze gelandet, davon ein Mal zum Preview Berlin gelangen.

- Phillip Valenta -- Entwickelte als Strategie den *Philipp Valenta Holdings* und produziert Luxus Kunst Objekte.

- Simone Weikelt -- TKM (Thüringer Kunstministerium) Stipendiatin, mehrere Ausstellungen und Aktiv in der Kunstbetrieb in Erfurt.

- Rosmarie Weinlich 
    - Leitet das ‚MOGA Salon Rejected’ einem in White Cube umfunktionierten Caravan, mit dem sie sich wie ein Parasit (nach Absprache und in Zusammenarbeit mit 
  diverse Institutionen, versteht sich) an Galerien andockt, um in ihrer Wohnwagen-Galerie diejenige Künstler auszustellen, die von der jeweiligen Galerie abgelehnt wurden.  
