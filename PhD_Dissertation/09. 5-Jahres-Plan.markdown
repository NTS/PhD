...
Notizen:
Die drei folgende Fachkurse sind der Basis meinem Praktischen Teil im Rahmen des PhD programms. Ich habe das Thema Kuratieren gewält, weil sie viel kooperation verlangt. 
Es ging um viele verschiedene Facetten des Arbeit an einem eigenen Ort, und nicht nur um das kuratieren.Ich habe die Anzahl der Teilnehmenden StudentInnen 
auf 15 beschränkt, damit nicht alles zu sehr ausufert einerseits, und die Verantwortungsfelder und Aufgaben ernstgenommen werden. Manche von ihnen haben alle 3 (in den Folgesemestern) belegt, was für sie eine sehr lange, aber auch runde Erfahrung versprach.
...
Ziel war es, nicht nur darum zu klären, wie man Geld verdient, sondern auch um die Vermittlung des Gefühls, wie es ist, 
wenn man die Verantwortung trägt, und es keine Semesterferien in dem Sinne gibt.

Ich finde diesen Ausdruck (Kuratorenschule) wiederum nicht ganz exakt, denn eigentlich ging es um das Vermitteln von Skills 
(Fähigkeiten) zum richtigen Organisieren von Kunst. 
