...
2007, beginnend mit meiner Stellenbesetzung, habe ich folgende Fachkurse abgehalten, die alle um das Studium Freie Kunst und das professionelle künstlerische Umfeld kreisen. 

Ich verstehe meine Aufgabe darin, alle Aspekte der Kunst und der Öffentlichkeitsarbeit systematisch zu untersuchen und das Wissen über Funktionsweisen 
des Kunstmarktes und die Entstehung guter Kunst zu vermitteln. Es geht hierbei um Kompetenzen, die nicht zwangsläufig zum Wissen eines Künstlers gehören müssen, 
...
Als ich studiert habe, durfte ich nicht einmal ausstellen. Wir hatten während des Studiums schlichtweg Ausstellungsverbot. Heute gestalte ich das Motiv der Ausstellungseinladungen selbst und habe das Sagen über die Schriftart, die ich mag und die ich nicht mag. Ich habe das Wort wie den Überblick über alles und ich werde aufgefordert Texte über meine Kunst zu schreiben. Wir übernehmen diese und andere Funktionen, wir können uns frei in ihnen bewegen. Wir sind gut darin, weil wir nicht mehr so stark 
auf Andere, Dritte angewiesen sind. Es gibt mittlerweile viele Galeristen, die in die Akademien gehen, so zum Beispiel der Jarmuschek ???? voller Name + Name Gallerie ????, der inzwischen Unterricht gibt. Das bedeutet auch, dass sich die Ebenen, die Institutionen 
vermischen, was schön zu sehen ist. Aber es wird auch immer den traditionellen Weg, die bekannten Rituale zwischen KünstlerIn und Käufer geben. Der Künstler malt und der Galerist verkauft. 
??? ab hier zum outro ??? ??? hier habe ich auch korrigiert, aber in dem abschnitt springen deine Gedanken noch etwas ???
Meiner Meinung nach werden mehrere, verschiedene Künstlersorten entstehen, die die 80 Assistenten haben und die, die keine haben. Die Assistenten erledigen nicht nur die Arbeit 
der Kunst, sondern übernehmen auch die Buchhaltung und alles was dazugehört. Ich selbst habe Fotografie studiert und Kunst um öffentlichen Raum produziert. 
Ich habe all diese Sachen gelernt und wir sind auch fähig dazu, da wir alle mit dem Computer arbeiten. Mittlerweile werde ich zu Projekten eingeladen, welche über 2 Jahre laufen. Ich erhalte 25.000.- Euro dafür, die ich dann an Studenten für Nebenjobs verteile. Somit bin ich als Künstlerin auch Arbeitgeberin, das gefällt mir am besten. 
...
hinzubekommen. In vielen Fällen funktioniert das auch, man kann fast gar nicht anders. Man muss lernen, ein größeres Bewusstsein für das gesamte Jahr zu entwickeln und nicht nur für den Zeitpunkt der jeweiligen Ausstellung. So guckt der Künstler auf den Kalender und meint: ‚Oh nein, ich habe dieses Jahr nur 2 Ausstellungen 
