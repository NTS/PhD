...
Gesellschaft etwas geändert. Joseph Beuys Aussage wurde auf den einen Satz: "Jeder ein Künstler" ??? heißt es nicht jeder Ist ein Künstler ??? reduziert, damit also der „Künstler“ relativiert. Das Originalzitat lautet: „... Ich sage, 
...
sind alle berühmt? ??? Das wiederholt sich in Kapitel 02 ??? Das heißt: Gilt die Aussage "Das kann mein Kind auch" in diesem Sinne? (Nicht nur Kinder können das, auch Affen (Arnulf Rainer), oder Elefanten (Komar und Melamid), 
...
Die erste Version des Mimes wurde im Februar 2012 ??? das stimmt glaube ich nicht, ich habe dieses Mime schon letztes Jahr und auch davor gesehen ??? auf *facebook* publiziert, und beschreibt die Rezeption des Schaffens eines Berufssegments 
...
Das Artist Statement von Charlotte Young, das sich auch über das Internet verbreitet hat, zeigt die schnelle Vergeltungskraft, oder vielleicht eher die Existenz eines sehr witzigen Dialogs, 
Ob es unter den Künstler nur gilt oder für andere Segmente auch gilt. ??? Ob was gilt ???Hi, my Name is Charlotte Young... so fängt der Werbefilm der Künstlerin an, die auf Englisch über sich als Künstlerin erzählt, während die "Wahrheit" bzw. eine Sozial-wirtschaftliche Interpretation über sie als eine Art Übersetzung im Untertitel läuft. Viele Künstler wurden dieser Diskrepanz zustimmen: Eine kreative Anzeige und gleichzeitig eines bissiges Geständnis zur Diskrepanz zwischen Eigenbewertung (wahrgenommener Realität und wie sie in Sprache als Selbstbewußtsein übersetzt wird.
