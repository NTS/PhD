...
2. Dokumentation, Recherche, und Theorie Schreiben (SoSe 10 / WS 10-11 / SoSe 11): Themen wie Änderungen und Entwicklung von Bereichen, wie Professionalisierung, PR Arbeit, und Kunstmarkt-Forschung in der Kunstlehre an Hochschulen, sowie eine Analyse der unterschiedlichen Facetten des Kiosks und Parallele dazu werden verglichen.
